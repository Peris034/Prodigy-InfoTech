...
label = tk.Label(frame, text="Enter the password:", bg="lightblue", fg="green", font=("Arial", 14))
...
check_button = tk.Button(frame, text="Check", command=check_password, bg="blue", fg="black", font=("Arial", 12))
check_button.grid(row=1, column=0, pady=10, padx=5, sticky="we")

generate_button = tk.Button(frame, text="Generate Password", command=generate_password, bg="green", fg="black",
                            font=("Arial", 12))
...
clear_button = tk.Button(frame, text="Clear", command=clear_input, bg="red", fg="black", font=("Arial", 12))
