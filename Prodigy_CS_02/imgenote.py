...
if __name__ == "__main__":
    input_image_path = r"/Users/mac/Desktop/Vac/Internship 2024/Prodigy_CS_02/sample input.png"
    img = Image.open(input_image_path)
    width, height = img.size
    key = np.random.randint(0, 256, size=(height, width, 3), dtype=np.uint8)  # 3 for RGB channels
    encrypted_image_path = 'encrypted output.jpg'    
    encrypted_array = encrypt_image(input_image_path, encrypted_image_path, key)
    decrypted_image_path = 'decrypted output.jpg'
